...
def matchReport(match_id):
    #5282227612
    #match_id = 5212816885
    if os.path.exists('f:/testdata/data/{}'.format(match_id)) is True:
        #os.rmdir('f:/testdata/data/{}'.format(match_id))
        shutil.rmtree('f:/testdata/data/{}'.format(match_id))
